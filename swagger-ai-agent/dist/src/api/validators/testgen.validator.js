...
exports.validateGenerateAxiosTestsRequest = validateGenerateAxiosTestsRequest;
function isObject(value) {
    return typeof value === 'object' && value !== null;
}
function validateGenerateAxiosTestsRequest(body) {
    if (!isObject(body)) {
...
//# sourceMappingURL=testgen.validator.js.map